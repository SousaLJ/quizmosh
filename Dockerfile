...
COPY --from=java-build --chown=10001:10001 /source/quizmosh-server/target/quizmosh-server-0.1.0-SNAPSHOT.jar /app/quizmosh.jar
...
ENTRYPOINT ["java", "-jar", "/app/quizmosh.jar"]
